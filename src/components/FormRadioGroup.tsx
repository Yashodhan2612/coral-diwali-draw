      ...
      >
        <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:bg-muted/50 transition-colors">
          <RadioGroupItem 
            ...
            className="shrink-0"
          />
          <Label htmlFor="raffle" className="cursor-pointer font-medium flex-1">
            Raffle
          </Label>
        </div>
        ...
        <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:bg-muted/50 transition-colors">
          <RadioGroupItem 
            ...
            className="shrink-0"
          />
          <Label htmlFor="games-vr" className="cursor-pointer font-medium flex-1">
            Games & VR
          </Label>
        </div>
        ...
        <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:bg-muted/50 transition-colors">
          <RadioGroupItem 
            ...
            className="shrink-0"
          />
          <Label htmlFor="both" className="cursor-pointer font-medium flex-1">
            Both
          </Label>
        </div>
      </RadioGroup>
